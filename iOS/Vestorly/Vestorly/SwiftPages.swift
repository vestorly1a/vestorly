...
class SwiftPages: UIView, UIScrollViewDelegate {
    ...
    override func drawRect(rect: CGRect)
    {
        ...
        //Set the top bar
        topBar = UIView(frame: CGRectMake(0, containerView.frame.height - topBarHeight, containerView.frame.size.width, topBarHeight))
        ...
        animatedBar = UIView(frame: CGRectMake(0, containerView.frame.height - animatedBarHeight - 3, (containerView.frame.size.width/(CGFloat)(viewControllerIDs.count))*0.8, animatedBarHeight))
        ...
        if (barShadow) {
            let shadowView = UIView(frame: CGRectMake(0,containerView.frame.height - 1, containerView.frame.size.width, 4))
